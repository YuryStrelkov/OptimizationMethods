...
1. Для языков программирования **c++**, **java**, **c#** использовать набры классов из **"numerics"**[here](OptimizationMethods/C++/OptimizationMethods/numerics), **"mathUtils"**[here](OptimizationMethods/), **"MathUtils"**[here](OptimizationMethods/).
2. Дихотомия
3. Золотое сечение
4. Фибоначчи
